...
export default function CasePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  async function submit() {
    ...
    if (takeover) {
      ...
      else { setResult(data === "deviation" ? "deviation" : "ok"); setStep(4); }
    } else {
